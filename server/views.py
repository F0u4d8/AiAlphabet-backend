...
from .serializers import UserSerializer ,CategorySerializer ,ContentSerializer,TodoSerializer
from .models import QRCode , UserProfile ,Category ,Content, Todo
...
@authentication_classes([SessionAuthentication, TokenAuthentication])
@permission_classes([IsAuthenticated])
def todo_detail_update_delete(request, todo_id):
    try:
